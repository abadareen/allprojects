...
class _MyHomePageState extends State<Fur> with SingleTickerProviderStateMixin {
        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              ...
              itemCard('FinnNavian', 'assets/image/ottoman.jpg', false),
              itemCard('FinnNavian', 'assets/image/anotherchair.jpg', true),
              itemCard('FinnNavian', 'assets/image/chair.jpg', true)
            ],
          )
        ],
      ),
