...
class _MyHomePageState extends State<Hair> {
  var selectedDate = 18;
        ...
        children: <Widget>[
          ...
          Container(
              ...
              child: ListView(
                ...
                scrollDirection: Axis.horizontal,
                children: <Widget>[
                  getBarber('assets/image/style1.jpg', 'Anton'),
                  SizedBox(width: 15.0),
                  getBarber('assets/image/style1.jpg', 'Jonathan'),
                  SizedBox(width: 15.0),
                  getBarber('assets/image/style3.jpeg', 'Jim'),
                  SizedBox(width: 15.0),
                ],
              )),
