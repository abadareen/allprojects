...
class _MyHomePageState extends State<Stats>
                ...
                Column(
                  children: <Widget>[
                    Row(
                      ...
                      children: <Widget>[
                        cardDetails(
                            'Pending payment', 'assets/image/card.png', '5'),
                        cardDetails(
                            'To be shipped', 'assets/image/box.png', '2'),
                      ],
                    ),
                    SizedBox(height: 10.0),
                    Row(
                      ...
                      children: <Widget>[
                        cardDetails(
                            'To be received', 'assets/image/trucks.png', '8'),
                        cardDetails('Return / Replace',
                            'assets/image/returnbox.png', '0'),
                      ],
                    ),
                    SizedBox(height: 5.0)
                  ],
      ...
      bottomNavigationBar: Material(
        ...
        child: TabBar(
          ...
          tabs: <Widget>[
            InkWell(
                onTap: () {
                  Navigator.of(context).pushNamed('/fur');
                },
                child: Tab(icon: Icon(Icons.event_seat, color: Colors.grey))),
