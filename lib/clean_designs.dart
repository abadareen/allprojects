...
class _MyHomePageState extends State<Chef> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: <Widget>[
        ...
        Column(
          children: <Widget>[
            menuCard('Berry banana milkshake', 'assets/image/bananabreak.jpg',
                'Breakfast', 4, 2.8, 1.2),
            SizedBox(height: 12.0),
            menuCard('Fruit pancake', 'assets/image/fruitbreak.jpeg',
                'Breakfast', 4, 4.2, 2.8),
          ],
        ),
        ...
        Padding(
          ...
          child: Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                getWorks('assets/image/fruitpancake.jpeg'),
                getWorks('assets/image/dumplings.jpeg'),
                getWorks('assets/image/noodles.jpeg'),
              ],
            ),
          ),
        ),
