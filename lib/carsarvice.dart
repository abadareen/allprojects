...
class _MyHomePageState extends State<Car> with SingleTickerProviderStateMixin {
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 20.0),
              Image.asset('assets/image/porsche-model.png',
                  fit: BoxFit.cover,
                  height: 175.0,
              ...
              Row(
                children: <Widget>[
                  Icon(Icons.refresh,
                      size: 35.0, color: Color(0xFF434C68).withOpacity(0.4)),
                  SizedBox(width: 10.0),
                  Text(
      ...
      bottomNavigationBar: Material(
        ...
        child: TabBar(
            ...
            tabs: <Widget>[
              ...
              Tab(
                  icon:
                      Icon(Icons.navigation, color: Colors.black, size: 25.0)),
            ]),
      ),
    );
  }
