...
class MinimalDes extends StatefulWidget {
  @override
  _MyHomePageState createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MinimalDes> {
  @override
            ...
            Container(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  SizedBox(width: 25.0),
                  listItem('assets/image/chris.jpg', 'Chris', true),
                  SizedBox(width: 25.0),
                  listItem('assets/image/hugh.jpg', 'Hugh', false),
                  SizedBox(width: 25.0),
                  listItem('assets/image/johnnydepp.jpg', 'Depp', false),
                  SizedBox(width: 25.0),
                  listItem('assets/image/tomcruise.jpg', 'Tom', false),
                ],
              ),
            ),
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image:
                                      AssetImage('assets/image/tomcruise.jpg'),
                                  fit: BoxFit.cover)),
                        ),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
